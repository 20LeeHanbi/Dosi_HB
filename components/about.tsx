...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"회사명","period":"2020 - 현재","description":"직무 및 역할"},{"icon":"graduation","title":"단국대학교 죽전캠퍼스","period":"2020 - 2026","description":"도시계획부동산학부 부동산학전공"},{"icon":"award","title":"자격증/수상","period":"2021","description":"설명을 입력하세요"}],
