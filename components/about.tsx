...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"회사명","period":"2020 - 현재","description":"직무 및 역할"},{"icon":"graduation","title":"단국대학교 죽전캠퍼스","period":"2020 - 2026","description":"도시계획부동산학부 부동산학전공"},{"icon":"award","title":"자격증/수상","period":"2020.12.15.","description":"설명을 입력하세요"}],
    skills: [{"icon":"code","title":"프론트엔드 개발","description":"React, TypeScript, Next.js를 활용한 모던 웹 개발"},{"icon":"database","title":"백엔드 개발","description":"Node.js, Python, 데이터베이스 설계 및 구현"},{"icon":"palette","title":"UI/UX 디자인","description":"사용자 중심의 인터페이스 디자인"},{"icon":"star","title":"새 스킬","description":"스킬 설명"}],
    storyTitle: "나의 이야기",
