...
export function About() {
  ...
  const defaultInfo = {
    ...
    storyTitle: "나의 이야기",
    story: ["대한민국을 비롯한 여러 국가에서 개인이 건축물을 분양 받거나, 기업이 부동산을 개발하는 등 대부분의 부동산활동은 금융을 통한 자금조달이 필수적입니다.","단국대학교에서 부동산학을 전공하고, 공인중개사와 투자자산운용사를 취득하며, 여러 프로젝트를 수행하는 등 부동산전공자로서의 전문지식과 부동산금융 관련 지식을 쌓았습니다.","건축자금대출, 브릿지론, 중도금대출, 숙박시설지원자금대출, 경락잔금대출, 기타부동산담보대출 등 안정적인 구조를 설계하고, 사업 자금을 제공하는 부동산금융인이 되겠습니다.","고객에게는 최고의 부동산금융 서비스를 제공하고, 회사에게는 사업성이 큰 빅딜을 따올 수 있는 부동산금융 전문가로 성장하겠습니다!"],
