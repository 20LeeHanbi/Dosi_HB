...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"한국투자저축은행","period":"2025 ~ 현재","description":"종합직(일반)"},{"icon":"graduation","title":"단국대학교 죽전캠퍼스","period":"2020 ~ 2026(졸업예정)","description":"도시계획부동산학부 부동산학전공"},{"icon":"trophy","title":"공인중개사","period":"2020.12.14.","description":"한국산업인력공단"},{"icon":"trophy","title":"투자자산운용사","period":"2023.02.23.","description":"한국금융투자협회"},{"icon":"award","title":"지방세 미래정책 대학생 아이디어 공모전 장려상 수상","period":"2024.06.28.","description":"한국지방세연구원"},{"icon":"award","title":"2024년 도시재생 청년인턴 해커톤 최우수상 수상","period":"2024.11.01.","description":"주택도시보증공사"}],
