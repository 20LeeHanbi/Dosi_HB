...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"한국투자저축은행","period":"2025 ~ 현재","description":"종합직(일반)"},{"icon":"briefcase","title":"경기신용보증재단","period":"2024.12~2025.01.","description":"인턴"},{"icon":"briefcase","title":"화성시 병점 도시재생현장센터","period":"2024.06~2024.11.","description":"인턴"},{"icon":"graduation","title":"단국대학교 죽전캠퍼스","period":"2020.03~2026.02.(졸업예정)","description":"도시계획부동산학부 부동산학전공"},{"icon":"trophy","title":"투자자산운용사","period":"2023.02.23.","description":"한국금융투자협회"},{"icon":"trophy","title":"공인중개사","period":"2020.12.14.","description":"한국산업인력공단"},{"icon":"award","title":"2024년 도시재생 청년인턴 해커톤 최우수상 수상","period":"2024.11.01.","description":"주택도시보증공사"},{"icon":"award","title":"제1회 지방세미래정책 대학생 아이디어 공모전 장려상 수상","period":"2024.06.28.","description":"한국지방세연구원"}],
    ...
    storyTitle: "나의 이야기",
    story: ["대한민국을 비롯한 여러 국가에서 개인이 건축물을 분양 받거나, 기업이 부동산을 개발하는 등 대부분의 부동산활동은 금융을 통한 자금조달이 필수적입니다.","단국대학교에서 부동산학을 전공하고, 공인중개사와 투자자산운용사를 취득하며, 여러 프로젝트를 수행하는 등 부동산전공자로서의 전문지식과 부동산금융 관련 지식을 쌓았습니다.","고객에게는 최고의 부동산금융 서비스를 제공하고, 회사에게는 사업성이 큰 빅딜을 따올 수 있는 부동산금융 전문가로 성장하겠습니다!"],
    storyImage: "/uploads/about-image-1763477644492.jpg",
    hobbies: ["📚 독서","🏃 러닝","🏊 수영"]
  }
