...
export const defaultConfig = {
    ...
    items: [{"name":"Home","url":"#hero","icon":"Home","show":true},{"name":"Intro","url":"#about","icon":"User","show":true},{"name":"Projects","url":"#projects","icon":"Briefcase","show":true},{"name":"Contact","url":"#contact","icon":"Mail","show":true},{"name":"갤러리","url":"#gallery","icon":"Camera","show":false},{"name":"블로그","url":"#blog","icon":"Book","show":false}],
    siteTitle: "My portfolio",
    siteDescription: "한국투자저축은행 행원 이한비입니다."
  }
